...
from utils import connect_to_server, display_message, process_query, AVAILABLE_MODELS
...
st.write("list three node labels")
...
if prompt := st.chat_input("What is up?"):
    ...
    for m in response[1:len(response)]:
        display_message(m)
        #print("\nmessage=",m.content)
    for m in response:
        m.pretty_print()
    ...
    #print("last msg=",response[-1].content)
