...
Neo4j_CONNECTION_URI = "bolt://localhost:7687" #"neo4j+s://localhost:7687"
...
def create_mcp_server(neo4j_driver: AsyncDriver, database: str = "neo4j") -> FastMCP:
    ...
    mcp: FastMCP = FastMCP("mcp-neo4j-cypher", host="127.0.0.1",port=8050, dependencies=["neo4j", "pydantic"])
...
if __name__ == "__main__":
    main(Neo4j_CONNECTION_URI,Neo4j_USERNAME,Neo4j_PASSWORD,Neo4j_DATABASE)
